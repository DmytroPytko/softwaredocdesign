...
export class ProjectService {
  ...
  protected convertDateFromClient(project: IProject): IProject {
    const copy: IProject = Object.assign({}, project, {
      startDate: project.startDate && project.startDate.isValid() ? project.startDate.toJSON() : undefined,
      endDate: project.endDate && project.endDate.isValid() ? project.endDate.toJSON() : undefined
    });
    return copy;
  }
